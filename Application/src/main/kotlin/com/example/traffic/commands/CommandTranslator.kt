...
object CommandTranslator {
     ...
     * @param intersectionController The manager that handles the intersection simulation.
     *
    */
    ...
    )
    {
        when (type)
        {
            "addVehicle" -> handleAddVehicle(vehicleId, startRoad, endRoad, stepResults, intersectionController)
            "step" -> handleStep(stepResults, intersectionController)
            "addRoad" -> handleAddRoad(direction, turnTypes, stepResults, intersectionController)
     ...
     * @param intersectionController The manager that modifies the intersection.
     *
     */
    private fun handleAddRoad(direction: String?, turnTypes: List<String>?, stepResults: MutableList<StepResponse>, intersectionController: IntersectionController) {
        if(direction == null)
        {
        ...
        intersectionController.addRoad(Direction.valueOf(directionString.uppercase()),
